...
import { DASHBOARD_PATH, isDashboardFormPath } from "@/shared/lib/navigation/dashboard";
...
export default function DashboardClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const showHomeLoading = useMinimumVisible(pathname === DASHBOARD_PATH && activeTab === "home" && isHomeLoading);
  const isFormScreen = isDashboardFormPath(pathname);

  return (
    <Column height={isFormScreen ? "100svh" : "calc(100svh - 97px)"}>
